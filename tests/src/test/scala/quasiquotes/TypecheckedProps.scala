...
//   val int = ScalaDot(newTypeName("Int"))
...
//     val pName1 = newTermName("x1")
//     val pName2 = newTermName("x2")
...
//     val lazyName = newTermName("x")
//     val lazyRhsVal = Literal(Constant(42))
...
//     val defName = newTermName("z")
//     val defRhsVal = Literal(Constant(42))
