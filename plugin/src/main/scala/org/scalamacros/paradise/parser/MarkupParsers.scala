 ...
 *  @version 1.0
 */
trait ParadiseMarkupParsers {
  self: ParadiseParsers =>
  ...
  class ParadiseMarkupParser(parser: ParadiseSourceFileParser, final val preserveWS: Boolean) extends ParadiseMarkupParserCommon {
